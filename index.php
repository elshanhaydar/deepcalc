...
<head>
    ...
    <meta name="description" content="Peşəkar qapı kalkulyatoru - optimal material hesablaması üçün">
    <title>Peşəkar Qapı Kalkulyatoru | QLBM Systems</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container py-4">
        <header class="main-header">
            <div class="logo-container">
                ...
                <h1>Peşəkar Qapı Kalkulyatoru</h1>
            </div>
            <p class="tagline">Sürətli və Dəqiq Material Hesablamaları</p>
        </header>

        <section class="calculator-form">
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-ruler-combined"></i> Qapı Ölçüləri</h2>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="doorWidth" class="form-label">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="doorHeight" class="form-label">
            ...
            <div class="card">
                <div class="card-header">
                    <h2><i class="fas fa-palette"></i> Rəng Seçimi</h2>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="colorCategory" class="form-label">
                                <i class="fas fa-layer-group"></i> Rəng Kateqoriyası:
                            </label>
                            <select id="colorCategory" onchange="updateColorOptions()" class="form-select">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="colorName" onchange="updateAvailableLengths()" class="form-select">
            ...
            <div class="tab-container">
                ...
                <div id="detailsTab" class="tab-content active">
                    ...
                    <div class="table-responsive">
                        <table id="materialsTable" class="data-table table">
                            <thead>
                                <tr>
                                    <th>Material</th>
                                    <th>Vahid qiymət</th>
                ...
                <div id="optimizationTab" class="tab-content">
                    ...
                    <div class="table-responsive">
                        <table id="optimalTable" class="data-table optimization-table table">
                            <thead>
                                <tr>
                                    <th>Material</th>
                                    <th>Uzunluq</th>
        ...
        <footer class="main-footer">
            <p>Peşəkar Qapı Kalkulyatoru &copy; 2025 | QLBM Systems</p>
            <p class="version">Versiya 2.5.0</p>
        </footer>
    </div>
